...
public class Commands {
    ...
    public static String quiry(String msg){
        ...
        switch(op){
            case ADDUSER : 
                    db.addUser(Integer.parseInt(param[0]),param[1],param[2],param[3],param[4],param[5]);
            break;
            case ADDADMIN : 
                    db.addAdmin(Integer.parseInt(param[0]),param[1],param[2],param[3],param[4],param[5]);
            break;
            case ADDPRODUCT : 
                    db.addProduct(Integer.parseInt(param[0]),param[1],Integer.parseInt(param[2]),Double.parseDouble(param[3]),Integer.parseInt(param[4]),param[5]);
            break;
            case ADDCATEGORY : 
                    db.addCategory(Integer.parseInt(param[0]),param[1],param[2]);
            break;
            case ADDTOCART : 
